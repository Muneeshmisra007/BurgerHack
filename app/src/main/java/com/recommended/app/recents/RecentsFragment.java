...
import static com.recommended.app.utils.AppConstants.TAG_RECENTS;
...
public class RecentsFragment extends BaseFragment implements AsyncListener<List<RecommendedItem>> {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerViewClickListener listener=new RecyclerViewClickListener() {
            ...
            public void onClick(View view, int position) {
                RecommendedItem item = mRecentsAdapter.getItemsList().get(position);
    ...
    private void addDetailFragment(RecommendedItem recommendedItem) {
        ...
        fragmentTransaction.addToBackStack(TAG_RECENTS);
